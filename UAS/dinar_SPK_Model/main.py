...
class BaseMethod():
    ...
    def data(self):
        ...
        return [{'id': smartphonesamsung.id, 
        'brand': DEV_SCALE_bran[smartphonesamsung.brand], 
        'ram': DEV_SCALE_ram[smartphonesamsung.ram], 
        'prosesor': DEV_SCALE_prosesor[smartphonesamsung.prosesor], 
        'storage': DEV_SCALE_storage[smartphonesamsung.storage], 
        'baterai': DEV_SCALE_baterai[smartphonesamsung.baterai], 
        'ukuran_layar': DEV_SCALE_ukuran_layar[smartphonesamsung.ukuran_layar], 
        'harga': DEV_SCALE_harga[smartphonesamsung.harga]} for smartphonesamsung in session.scalars(query)]
